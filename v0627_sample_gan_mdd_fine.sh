#!/bin/bash
#SBATCH --job-name=v0627_sample_gan_fine
#SBATCH --account=hdb
...
#SBATCH --output=v0627_sample_gan_fine_%j.out
...
CKPT="/xdisk/hdb/emcdugald/v0627/checkpoints/gan/bcLoc-fine_bcDofs-fine_loadLoc-fine_loadDir-fine_massLabel_low_mass_epochs200_bs16_nz512_ngf256_ndf128_nsamp10000_lrD1e-04_lrG2e-04_smoothR0.10_dEvery5_div0.01_fine_run_20260628-230723/ckpt_best.pt"

OUTDIR="/xdisk/hdb/emcdugald/v0627/sampler_tests/gan_fine_ckpt_best_20260630"
DEVICE="cuda"
