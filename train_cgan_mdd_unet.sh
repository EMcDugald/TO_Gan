#!/bin/bash
#SBATCH --job-name=cgan_mdd_unet_v2_0626
#SBATCH --account=hdb
...
#SBATCH --output=cgan_mdd_unet_v2_%j.out
...
CKPT_ROOT="/xdisk/hdb/emcdugald/to_cond_gan/checkpoints_323232_fine_unet_v2_2_0626"
SCRIPT="/home/u26/emcdugald/TO_Gan/PoC_3d/train_gan_unet_v2.py"
