#!/bin/bash
#SBATCH --job-name=v0627_sample_diff_fine
#SBATCH --account=hdb
...
#SBATCH --output=v0627_sample_diff_fine_%j.out
...
META_FILE="/xdisk/hdb/emcdugald/v0627/train_data/diffusion/10000_diffusion_condLabel_voxels_32x32x32_bcLoc-fine_bcDofs-fine_loadLoc-fine_loadDir-fine_low_mass_thr0.494781_meta.npz"

CKPT="/xdisk/hdb/emcdugald/v0627/checkpoints/diffusion/bcLoc-fine_bcDofs-fine_loadLoc-fine_loadDir-fine_massLabel-low_mass_mode-X0_epochs-500_bs-4_c1-32_c2-64_c3-128_20260629-001905/checkpoints/ckpt_best.pth"

OUTDIR="/xdisk/hdb/emcdugald/v0627/sampler_tests/diffusion_fine_ckpt_best_20260630"
