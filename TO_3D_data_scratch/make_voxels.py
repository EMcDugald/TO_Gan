...
os.makedirs(os.getcwd()+'/TO_3D_data_scratch/voxels', exist_ok=True)
os.makedirs(os.getcwd()+'/TO_3D_data_scratch/voxel_fig', exist_ok=True)
...
for idx in generated_indices:
    ...
    npy_path = os.getcwd()+ f'/TO_3D_data_scratch/voxels/voxel_{idx}.npy'
    ...
    gif_path = os.getcwd()+f'/TO_3D_data_scratch/voxel_fig/voxel_{idx}.gif'
    ...
    fig.savefig(os.getcwd()+f'/TO_3D_data_scratch/voxel_fig/voxel_{idx}_3d.png')
    plt.close(fig)